...
class ChestServiceImpl : ChestService {
    ...
    private val tier1Materials = WeightedList<Material>().apply {
        ...
        // 革防具（中確率）
        add(Material.LEATHER_HELMET, 1.0)
        add(Material.LEATHER_CHESTPLATE, 0.8)
        add(Material.LEATHER_LEGGINGS, 1.0)
        add(Material.LEATHER_BOOTS, 1.2)
    ...
    private val tier2Materials = WeightedList<Material>().apply {
        ...
        add(Material.GOLDEN_APPLE, 0.5)
        add(Material.MUSHROOM_SOUP, 1.5)
    ...
    override fun fillTier1Chest(chest: Chest?) {
        chest?.let { fill(it, tier1Materials) }
    }

    override fun fillTier2Chest(chest: Chest?) {
        chest?.let { fill(it, tier2Materials) }
    }
